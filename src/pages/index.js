    ...
    >
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="text-center">
              <div className="bg-dental-light rounded-full w-12 h-12 flex items-center justify-center mx-auto mb-4">
                <svg className="w-6 h-6 text-dental-blue" fill="currentColor" viewBox="0 0 20 20">
      ...
      <section className="py-16 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-white rounded-lg shadow-lg p-8 text-center max-w-md mx-auto border-4 border-dental-blue relative">
              ...
              <h3 className="text-2xl font-bold text-gray-900 mb-4">All Invisalign Cases</h3>
              <div className="text-4xl font-bold text-dental-blue mb-2">£3,999</div>
              <div className="text-gray-600 mb-6">or £167/month</div>
              <ul className="text-left space-y-2 mb-8">
                ...
                <li className="flex items-center">
                  ...
                  All aligners & refinements included
                </li>
                <li className="flex items-center">
                  <svg className="w-5 h-5 text-green-500 mr-2" fill="currentColor" viewBox="0 0 20 20">
                    <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd"/>
                  </svg>
                  Consultation & retainers included
                </li>
                <li className="flex items-center">
                  <svg className="w-5 h-5 text-green-500 mr-2" fill="currentColor" viewBox="0 0 20 20">
                    <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd"/>
          ...
          <div className="text-center mt-12">
            <p className="text-gray-600 mb-6">
              One simple price includes everything: consultation, treatment planning, all aligners, monitoring visits, refinements, and retainers.
            </p>
